...
#' @keywords internal
pguides_gengrob <- function(scales, range, coord, theme) {
  # apply pguide_gengrob for each guide
  guides <- llply(scales, function(sc) llply(sc$guide, pguide_gengrob, range, sc, coord, theme))
  # merge all grob
...
#' @keywords internal
pguide_gengrob <- function(pguide, ginfo, scale, coord, theme) {
  UseMethod("pguide_gengrob")
}

#' @keywords internal
pguide_gengrob_not_found <- function(pguide, ginfo, scale, coord, theme) {
...
pguide_gengrob.axis <- function(pguide, ginfo, scale, coord, theme) UseMethod("pguide_gengrob.axis", coord)

#' @S3method pguide_gengrob.axis default
pguide_gengrob.axis.default <- pguide_gengrob_not_found

#' @S3method pguide_gengrob range
pguide_gengrob.range <- function(pguide, ginfo, scale, coord, theme) UseMethod("pguide_gengrob.range", coord)
